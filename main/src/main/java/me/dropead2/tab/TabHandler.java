package me.dropead2.tab;

import lombok.Getter;
import lombok.SneakyThrows;
import me.dropead2.tab.entry.TabElement;
import me.dropead2.tab.entry.TabElementHandler;
...
public class TabHandler {
    ...
    private TabAdapter createAdapter() throws ClassNotFoundException, IllegalAccessException, InstantiationException {
        ...
        final String disguisePackage = "me.dropead2.tab.v" + nmsVersion.toLowerCase() + ".v" + nmsVersion;
